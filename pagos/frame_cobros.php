			...
			<form name="form1" id="form1">		
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="12%"><div align="center"><? echo implota(mysqli_result($res_resultado,$contador,"facturasp.fechapago"))?></div></td>
							<td width="12%"><div align="center"><? echo number_format(mysqli_result($res_resultado,$contador,"importe"),2,",",".")?></div></td>							
							<td width="20%"><div align="center"><? echo mysqli_result($res_resultado,$contador,"nombrefp")?></div></td>
