...
<head>
    ...
    <script language="javascript">
        ...
        $(document).ready(function() {
            ...
            //$('#subresources_menu').toggle($('#resources_menu').is(':hidden'));
...
<div id="icono"><a href="#" id="new_menu"><img class="imgicon" src="./img/menug.svg" onclick="openMenu()"></a></div>
</div>
    ...
    <div id="left_side">
        <a href="./central2.php" target="principal" id="home"><img src="./img/w-home.svg" class="iconolado home" alt="inizio"></a>
