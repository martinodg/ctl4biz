...
//    $pdf->Cell(80,4,"Tlfno: " . $lafila["telefono"] . "  " . "Movil: " . $lafila["movil"],'LR',0,'L',1);
    ...
    $pdf->Cell(80);
    $pdf->Cell(30,4,$lang->tu('nif'),1,0,'C',1);
	$pdf->Cell(30,4,$lang->tu('codigo_proveedor'),1,0,'C',1);
	$pdf->Cell(30,4,$lang->tu('fecha'),1,0,'C',1);
	$pdf->Cell(20,4,$lang->tu('codigo_factura'),1,0,'C',1);
	$pdf->Ln(4);
