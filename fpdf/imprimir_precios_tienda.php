...
$pdf->SetY(20);
$pdf->SetX(0);
$pdf->MultiCell(290,6,$lang->t('lista_articulos_tienda'),0,'C',0);
...
$numero_articulos=mysqli_num_rows($rs_articulos);
		if ($numero_articulos>0) {		
			...
			$header=array($lang->t('item'),$lang->t('familia'),$lang->t('referencia'),$lang->t('descripcion'),$lang->t('p_compra_tienda'));
