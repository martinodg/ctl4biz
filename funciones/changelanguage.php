...
class ChangeLanguage
{
    ...
    private $_palabras = array(
        ...
        'nif' => array('nif', 'nif', "polski", "italian", "portugues", "frances", "Aleman"),
        ...
        'euro' => array('Euro', 'Euro', "polski", "italian", "portugues", "frances", "Aleman"),
        'euros' => array('Euros', 'Euros', "polski", "italian", "portugues", "frances", "Aleman"),
        'base_imponible' => array('Taxable', 'Base Imponible', "polski", "italian", "Tributábel", "frances", "Aleman"),
        'couta_iva' => array('VAT fee', 'Cuota IVA', "polski", "italian", "portugues", "frances", "Aleman"),
        'iva' => array('tax', 'iva', "polski", "italian", "portugues", "frances", "Aleman"),
        ...
        'cif_nif' => array('CIF/NIF', 'CIF/NIF', "polski", "italian", "portugues", "frances", "Aleman"),
