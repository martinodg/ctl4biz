...
var vart=["english","Mostrar todos los artículos","polski","italian","portugues","frances","Aleman"];
var si=["english","si","polski","italian","portugues","frances","Aleman"];
var no=["english","no","polski","italian","portugues","frances","Aleman"];
var selart=["english","Seleccionar Articulo","polski","italian","portugues","frances","Aleman"];
var tipo=["english","tipo","polski","italian","portugues","frances","Aleman"];
var sel=["english","Selecciona","polski","italian","portugues","frances","Aleman"];
var elart=["english","eliminar articulo","polski","italian","portugues","frances","Aleman"];
var impuesto=["english","Impuesto","polski","italian","portugues","frances","Aleman"];
var prov1=["supplier","proveedor 1","dostawca","fornitore","fornecedor","fournisseur","Lieferant"];
var prov2=["supplier","proveedor 2","dostawca","fornitore","fornecedor","fournisseur","Lieferant"];
var ubicacion=["english","ubicación","polski","italian","portugues","frances","Aleman"];
var avisominimo=["english","aviso mínimo","polski","italian","portugues","frances","Aleman"];
var sindet=["english","Sin determinar","polski","italian","portugues","frances","Aleman"];
var embalaje=["english","embalaje","polski","italian","portugues","frances","Aleman"];
var mdesctick=["english","Modificar descrip. ticket","polski","italian","portugues","frances","Aleman"];
var prectienda=["english","Precio en tienda","polski","italian","portugues","frances","Aleman"];
var prcciva=["english","Precio con iva","polski","italian","portugues","frances","Aleman"];
var tdsfam=["english","Todas las familias","polski","italian","portugues","frances","Aleman"];
var realcionart=["english","Relación de articulos","polski","italian","portugues","frances","Aleman"];
var ndartenctn=["english","N de articulos encontrados","polski","italian","portugues","frances","Aleman"];
var undmed=["english","Und./medida","polski","italian","portugues","frances","Aleman"];
var modarticulo=["english","MODIFICAR ARTICULO","polski","italian","portugues","frances","Aleman"];
var tdsembalajes=["english","Todos los embalajes","polski","italian","portugues","frances","Aleman"];
var moddesctick=["english","Modificar descrip. en ticket","polski","italian","portugues","frances","Aleman"];
var palmacen=["english","Precio de almacén","polski","italian","portugues","frances","Aleman"];
var ptienda=["english","Precio de tienda","polski","italian","portugues","frances","Aleman"];
var imgfrmjpg=["english","Imagen [Formato jpg]","polski","italian","portugues","frances","Aleman"];
...
function langchange(idioma) {
    ...
    $("#tprov1").text(prov1[idioma]);
    $("#tprov2").text(prov2[idioma]);
    ...
    $("#tvart").text(vart[idioma]);
    $("#tselart").text(selart[idioma]);
    $("#ttipo").text(tipo[idioma]);
    $("#tsel").text(sel[idioma]);
    $("#telart").text(elart[idioma]);
    $("#timpuesto").text(impuesto[idioma]);
    $("#tdesccorta").text(desccorta[idioma]);
    $("#tubicacion").text(ubicacion[idioma]);
    $("#tunidades").text(unidades[idioma]);
    $("#tstock").text(stock[idioma]);
    $("#tstkmin").text(stkmin[idioma]);
    $("#tavisominimo").text(avisominimo[idioma]);
    $("#tdatroduc").text(datroduc[idioma]);
    $("#tfchaalta").text(fchaalta[idioma]);
    $("#tsindet").text(sindet[idioma]);
    $("#tunidcaja").text(unidcaja[idioma]);
    $("#tpregpciotk").text(pregpciotk[idioma]);
    $("#tembalaje").text(embalaje[idioma]);
    $("#tmdesctick").text(mdesctick[idioma]);
    $("#tobsev").text(obsev[idioma]);
    $("#tpciocomp").text(pciocomp[idioma]);
    $("#tpcioalma").text(pcioalma[idioma]);
    $("#tprectienda").text(prectienda[idioma]);
    $("#tprcciva").text(prcciva[idioma]);
    $("#tcodbarr").text(codbarr[idioma]);
    $("#tbuscaart").text(buscaart[idioma]);
    $("#tcodart").text(codart[idioma]);
    $("#tnuevo").text(nuevo[idioma]);
    $("#ttrealcionart").text(realcionart[idioma]);
    $("#tndartenctn").text(ndartenctn[idioma]);
    $("#tpreciot").text(preciot[idioma]);
    $("#tundmed").text(undmed[idioma]);
    $("#tmodarticulo").text(modarticulo[idioma]);
    $("#tmoddesctick").text(moddesctick[idioma]);
    $("#tpalmacen").text(palmacen[idioma]);
    $("#tptienda").text(ptienda[idioma]);
    $("#timgfrmjpg").text(imgfrmjpg[idioma]);
    $("#tinsart").text(insart[idioma]);
