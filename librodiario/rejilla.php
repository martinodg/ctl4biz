			...
			<input type="hidden" name="numfilas" id="numfilas" value="<? echo $filas?>">
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
						  <? if (mysqli_result($res_resultado,$contador,"tipodocumento")==1) { 
							...
							<td width="10%"><div align="center"><? echo implota(mysqli_result($res_resultado,$contador,"fecha"))?></div></td>
							<td width="10%"><div align="center"><? echo $movimiento?></div></td>							
							<td width="10%"><div align="center"><? echo mysqli_result($res_resultado,$contador,"coddocumento")?></div></td>
							<td class="aDerecha" width="20%"><div align="center"><? echo $nombrecomercial?></div></td>
							<td class="aDerecha" width="20%"><div align="center"><? echo mysqli_result($res_resultado,$contador,"nombrefp")?></div></td>
							<td class="aDerecha" width="15%"><div align="center"><? echo mysqli_result($res_resultado,$contador,"numpago")?></div></td>							
							<td width="10%"><div align="center"><? echo number_format(mysqli_result($res_resultado,$contador,"total"),2,",",".");?></div></td>
						</tr>
						<? $contador++;
							}
						?>			
					...
					<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
						<tr>
                            <td width="100%" class="mensaje"><span  id="tmsgmovfn">No hay ning&uacute;n movimiento que cumpla con los criterios de b&uacute;squeda</span></td>
					    </tr>
					</table>					
					<? } ?>	
					</form>				
