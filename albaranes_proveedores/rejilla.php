				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="6%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_albaran('<?php echo mysqli_result($res_resultado,$contador,"codalbaran")?>',<?php echo mysqli_result($res_resultado,$contador,"codproveedor")?>,<? echo $marcaestado?>)" title="Modificar"></a></div></td>
							...
							<td width="6%"><div align="center"><a href="#"><img src="../img/convertir.png" width="16" height="16" border="0" onClick="convertir_albaran('<?php echo mysqli_result($res_resultado,$contador,"codalbaran")?>',<?php echo mysqli_result($res_resultado,$contador,"codproveedor")?>,<? echo $marcaestado?>)" title="Facturar"></a></div></td>
						</tr>
						<? $contador++;
							}
						?>			
