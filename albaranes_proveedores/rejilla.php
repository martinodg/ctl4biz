				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="5%"><div align="center"><a href="#"><img src="../img/modificar.svg" width="16" height="16" border="0" onClick="modificar_albaran('<?php echo mysqli_result($res_resultado,$contador,"codalbaran")?>',<?php echo mysqli_result($res_resultado,$contador,"codproveedor")?>,<? echo $marcaestado?>)" data-opttrad="modificar" title="Modificar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img src="../img/ver.svg" width="16" height="16" border="0" onClick="ver_albaran('<?php echo mysqli_result($res_resultado,$contador,"codalbaran")?>',<?php echo mysqli_result($res_resultado,$contador,"codproveedor")?>)" data-opttrad="visualizar" title="Visualizar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img src="../img/eliminar.svg" width="16" height="16" border="0" onClick="eliminar_albaran('<?php echo mysqli_result($res_resultado,$contador,"codalbaran")?>',<?php echo mysqli_result($res_resultado,$contador,"codproveedor")?>)" data-opttrad="eliminar" title="Eliminar"></a></div></td>
