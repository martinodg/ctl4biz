...
<? if ($nrs>0) { ?>
		<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
		  <tr>
			<td width="15%"><div align="center"><b><span id="tflia">Familia</span></b></div></td>
			<td width="15%"><div align="center"><b><span id="trefren">Referencia</span></b></div></td>
			<td width="40%"><div align="center"><b><span id="tdescri">Descripci&oacute;n</span></b></div></td>
			<td width="20%"><div align="center"><b><span id="tprecio">Precio</span></b></div></td>
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codfamilia?>,<?php echo $codarticulo?>,'<?php echo $codigobarras?>','<?php echo str_replace('"','',$descripcion)?>','<?php echo $precio?>')"><img src="../img/convertir.svg" width="16px" height="16px" border="0" data-ttitle="tsel" title="Seleccionar"></a></div></td>
				</tr>
			<?php }
		?>
  </table>
