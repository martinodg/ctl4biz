			...
			<form name="form1" id="form1">		
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="12%"><div align="center"><? echo implota(mysqli_result($res_resultado,$contador,"fechacobro"))?></div></td>
					...
					<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							<td width="100%" class="mensaje"><span id="tmsgtdbprocobro">Todav&iacute;a no se ha producido ning&uacute;n cobro de esta factura</span>.</td>
					    </tr>
					</table>					
					<? } ?>	
					</form>				
