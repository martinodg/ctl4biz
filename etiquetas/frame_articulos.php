...
<? if ($nrs>0) { ?>
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo('<?php echo $codigobarras?>','<?php echo str_replace('"','',$descripcion)?>')"><img src="../img/convertir.svg" width="16px" height="16px" border="0" data-ttitle="tsel" title="Seleccionar"></a></div></td>
				</tr>
			<?php }
		?>
  </table>
