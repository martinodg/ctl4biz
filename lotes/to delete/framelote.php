...
<? if ($nrs>0) { ?>
        ...
        <div align="center"><?php echo $horaf;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codlote?>,'<?php echo $codarticulo?>','<?php echo $cantidad?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>
				</tr>
			<?php }
		?>
  </table>
