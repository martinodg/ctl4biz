...
if (mysqli_num_rows($result) > 0) {
    ...
    $output .= "El nombre de la base de datos es: " . $id_company . "<br>";
    ...
    // Create database
    $output .= "Creando base de datos<br>";
    $sql = "CREATE DATABASE " . $id_company . ";";
    $output .= $sql . "<br>";
    if ($conn1->query($sql) === TRUE) {
        $output .= "Database created successfully<br>";
    } else {
        $output .= "Error creating database: " . $conn1->error . "<br>";
    }
    $output .= "**********************************************************<br>";
    $output .= "Creando usuario<br>";
    ...
    if ($conn1->query($sql2) === TRUE) {
        $output .= "User created successfully<br>";
    } else {
        $output .= "Error creating user: " . $conn1->error . "<br>";
    }
    $output .= "**********************************************************<br>";
    $output .= "Dando privilegios al usuario<br>";
    ...
    if ($conn1->query($sql3) === TRUE) {
        $output .= "Privileges granted successfully<br>";
    } else {
        $output .= "Error granting permits: " . $conn1->error . "<br>";
    }
    $conn1->close();
    $output .= "**********************************************************<br>";
    $output .= "Importando tabla<br>";
