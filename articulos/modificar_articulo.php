...
<head>
    ...
    <script language="javascript">
        ...
        $(document).ready(function () {
            ...
            $.get("../funciones/BackendQueries/getMeassuresUnits.php", {
                    articulo: document.getElementById('id').value,
        ...
        $(document).ready(function () {
            ...
            var campoHTML = '<div class="pack_add" style="margin-bottom: 10px;"><select id="cboEmbalaje" name="AEmbalajes[]" class="comboGrande cboEmbalajes"></select><button type="button" onMouseOver="style.cursor=cursor"  class="remove_button" title="Remove field" style="cursor:pointer; margin-left: 5px; padding-bottom: 3px;"><img src="../img/eliminar.svg" name="Image1" id="Image1" width="16" height="16" border="0" id="Image1"></button></div>'; //New input field html
        ...
        function delete_embalajes(id_embalajes) {
            fila = document.getElementById(id_embalajes);
            embalajes = document.getElementsByClassName(id_embalajes);
            embalajes.value = "";
            $.get("../funciones/BackendQueries/getPackaging.php?idEmbalaje_remove=" + id_embalajes, function (data) {
...
<div id="pagina">
    <div id="zonaContenido">
        <div align="center">
            ...
            <div id="frmBusqueda">
                <form id="formulario" name="formulario" method="post" action="guardar_articulo.php"
                    ...
                    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                        <tr>
                            ...
                            <td><input class="cajaGrande" value="<?php echo $codarticulo ?>" type="text" style="text-align: center" disabled></td>
                        </tr>
                        <tr>
                            <td width="20%"><span id="tcodbarr">Codigo de barras</span></td>

                            <td colspan="2"><input name="codigobarras" id="codigobarras"
                                                   value="<?php echo $codigobarras ?>" maxlength="20" class="cajaGrande"
                                                   type="text"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input name="areferencia" id="mreferencia"
                                                   value="<?php echo mysqli_result($rs_query, 0, "referencia") ?>"
                                                   maxlength="20" class="cajaGrande" type="text"></td>
                            <!--alias start-->
                        <tr>
                            <td><span id="new-alias">Nuevos Alias</span></td>
                            <td id="campo_alias">
                                <div class="alia_add">
                                    <button class="add_button" type="button" onMouseOver="style.cursor=cursor"
                                            style="text-decoration: none; color: #ffff;">
                                        <img src="../img/agregar.svg" name="Image1" id="Image1" width="16" height="16"
                                             border="0" id="Image1" onMouseOver="this.style.cursor=pointer"><span
                                                id="add-alias"> AGREGAR ALIAS</span>
                                    </button>
                                </div>
                            </td>
                        </tr>
                        ...
                        if (!empty($rowAlias)){
                            echo "<tr><td><strong id='talias' style= 'color: #ff9500;'>Alias</strong></td></tr>";
                            while (!empty(mysqli_result($rsAlias_query, $connt, "alias"))){
                                ...
                                <tr id="<?php echo $aliasid; ?>">
                                    <td><span style=" color: #ff9500; margin-left: 35px;">➤</span></td>
                                    <td id="campo_alias">
                                        <div class="alia_add">
                                            <input id="<?php echo $aliasid; ?>" type="text"
                                                   name="alias[<?php echo $aliasid; ?>]" value="<?php echo $aliasnombre; ?>"
                                                   class="cajaGrande"/>
                                            <button type="button" onMouseOver="style.cursor=cursor"
                                                    onclick="delete_alias(<?php echo $aliasid; ?>)"
                                                    style="cursor:pointer; padding-bottom: 3px;">
                                                <img src="../img/eliminar.svg" name="Image1" id="Image1" width="16" height="16"
                                                     border="0" id="Image1" style="cursor:pointer; margin-left: 5px;">
                                            </button>
                                            <?php
                                    echo '
                                        </div>
                                ...
                                echo "<tr><td><strong id='talias' style= 'color: #ff9500;'>Alias</strong></td><td>No Existen Alias para este Articulo</td></tr>";
                            }
                            ?>
                                    <!--alias end-->
                                ...
                                <select id="cboFamilias" name="AcboFamilias" class="comboGrande">
                                    ...
                                    while ($contador < mysqli_num_rows($res_familias)) {
                                        if ($familia == mysqli_result($res_familias, $contador, "codfamilia")) { ?>
                                            <option value="<?php echo mysqli_result($res_familias, $contador, "codfamilia") ?>"
                                                    selected="selected"><?php echo mysqli_result($res_familias, $contador, "nombre") ?></option>
                                        <? } else { ?>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><textarea name="Adescripcion" cols="41" rows="2" id="descripcion"
                                                      class="areaTexto"><?php echo mysqli_result($rs_query, 0, "descripcion") ?></textarea>
                            </td>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <select id="cboImpuestos" name="cboImpuestos" class="comboMedio">
                                    ...
                                    while ($contador < mysqli_num_rows($res_impuesto)) {
                                        if ($impuesto == mysqli_result($res_impuesto, $contador, "valor")) { ?>
                                            <option value="<?php echo mysqli_result($res_impuesto, $contador, "valor") ?>"
                                                    selected="selected"><?php echo mysqli_result($res_impuesto, $contador, "valor") ?></option>
                                        <? } else { ?>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><select id="cboProveedores1" name="acboProveedores1" class="comboGrande">
                                    <? if ($proveedor1 == 0) { ?>
                                        <option value="0" selected="selected" data-opttrad="todprov">Todos los
                                            proveedores
                                        </option>
                                    <? } else { ?>
                                    ...
                                    while ($contador < mysqli_num_rows($res_proveedores)) {
                                        if (mysqli_result($res_proveedores, $contador, "codproveedor1") == $proveedor1) { ?>
                                            <option value="<?php echo mysqli_result($res_proveedores, $contador, "codproveedor1") ?>"
                                                    selected><?php echo mysqli_result($res_proveedores, $contador, "nif") ?>
                                                -- <?php echo mysqli_result($res_proveedores, $contador, "nombre") ?></option>
                                        <? } else { ?>
                                            <option value="<?php echo mysqli_result($res_proveedores, $contador, "codproveedor1") ?>"><?php echo mysqli_result($res_proveedores, $contador, "nif") ?>
                                                -- <?php echo mysqli_result($res_proveedores, $contador, "nombre") ?></option>
                                        <? }
                                        $contador++;
                                    } ?>
                            ...
                            <td colspan="2"><select id="cboProveedores2" name="acboProveedores2" class="comboGrande">
                                    ...
                                    while ($contador < mysqli_num_rows($res_proveedores)) {
                                        if (mysqli_result($res_proveedores, $contador, "codproveedor2") == $proveedor2) { ?>
                                            <option value="<?php echo mysqli_result($res_proveedores, $contador, "codproveedor2") ?>"
                                                    selected><?php echo mysqli_result($res_proveedores, $contador, "nif") ?>
                                                -- <?php echo mysqli_result($res_proveedores, $contador, "nombre") ?></option>
                                        <? } else { ?>
                                            <option value="<?php echo mysqli_result($res_proveedores, $contador, "codproveedor2") ?>"><?php echo mysqli_result($res_proveedores, $contador, "nif") ?>
                                                -- <?php echo mysqli_result($res_proveedores, $contador, "nombre") ?></option>
                                        <? }
                                        $contador++;
                                    } ?>
                                ...
                                <select id="cboUbicacion" name="AcboUbicacion" class="comboGrande">
                                    ...
                                    while ($contador < mysqli_num_rows($res_ubicacion)) {
                                        if (mysqli_result($res_ubicacion, $contador, "codubicacion") == $codubicacion) { ?>
                                            <option value="<?php echo mysqli_result($res_ubicacion, $contador, "codubicacion") ?>"
                                                    selected><?php echo mysqli_result($res_ubicacion, $contador, "nombre") ?></option>
                                        <? } else { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="unidad" class="cboUnidadmedida" name="Aunimedida"
                                        onchange="definirUnimedida()">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td><span id="tstock">Stock</span></td>
                            <td colspan="2"><input NAME="nstock" type="text" class="cajaPequena" id="stock" size="10"
                                                   maxlength="10"
                                                   value="<?php echo mysqli_result($rs_query, 0, "stock") ?>"></td>
                        </tr>
                        <tr>
                            <td><span id="tstkmin">Stock m&iacute;nimo</span></td>
                            <td colspan="2"><input NAME="nstock_minimo" type="text" class="cajaPequena"
                                                   id="stock_minimo" size="8" maxlength="8"
                                                   value="<?php echo mysqli_result($rs_query, 0, "stock_minimo") ?>">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><textarea name="adatos" cols="41" rows="2" id="datos"
                                                      class="areaTexto"><?php echo mysqli_result($rs_query, 0, "datos_producto") ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td><span id="tfchaalta">Fecha de alta</span></td>
                            <td colspan="2"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10"
                                                   maxlength="10" readonly
                                                   value="<?php echo implota(mysqli_result($rs_query, 0, "fecha_alta")) ?>">
                                <img src="../img/calendario.svg" name="Image1" id="Image1" width="16" height="16"
                                     border="0" id="Image1" onMouseOver="this.style.cursor='pointer'">
                        ...
                        <!--add Packaging Start-->
                        <tr>
                            <td><span id="tnew-embalaje">Nuevos Embalajes</span></td>
                            <td id="campo_embalaje">
                                <div class="pack_add">
                                    <button class="add_button_embalaje" type="button" onMouseOver="style.cursor=cursor"
                                            onclick="definirUnimedida()" style="text-decoration: none; color: #ffff;">
                                        <img src="../img/agregar.svg" name="Image1" id="Image1" width="16" height="16"
                                             border="0" id="Image1" onMouseOver="this.style.cursor='pointer'"><span
                                                id="add-embalaje"> AGREGAR EMBALAJE</span>
                                    </button>
                                </div>
                            </td>
                        </tr>
                        <tr><td><strong id="tembalaje" style="color: #ff9500;">Embalaje</strong></td></tr>
                        <? $contador = 0;
                        while (!empty(mysqli_result($rs_embalajes, $contador, "nombre"))){
                            $name_embalaje = mysqli_result($rs_embalajes, $contador, 'nombre');
                            $id_embalaje = mysqli_result($rs_embalajes, $contador, "codembalaje"); ?>
                            <tr id="<?php echo $id_embalaje; ?>">
                                <td><span style=" color: #ff9500; margin-left: 35px;">➤</span></td>
                                <td id="campo_embalaje">
                                    <div class="pack_add">
                                        <input id="<?php echo $id_embalaje; ?>" type="text" name="AEmbalajes[<?php echo $id_embalaje; ?>]" value="<?php echo $name_embalaje; ?>" class="cajaGrande" disabled/>
                                        <button type="button" onMouseOver="style.cursor=cursor"
                                                onclick="delete_embalajes(<?php echo $id_embalaje; ?>)"
                                                style="cursor:pointer; padding-bottom: 3px;">
                                            <img src="../img/eliminar.svg" name="Image1" id="Image1" width="16" height="16"
                                                 border="0" id="Image1" style="cursor:pointer; margin-left: 5px;">
                                        </button>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <select name="aprecio_ticket" id="precio_ticket" class="comboPequeno">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <select name="amodif_descrip" id="modif_descrip" class="comboPequeno">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><textarea name="aobservaciones" cols="41" rows="2" id="observaciones"
                                                      class="areaTexto"><?php echo mysqli_result($rs_query, 0, "observaciones") ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td><span id="tpciocomp">Precio de compra</span></td>
                            <td colspan="2"><input NAME="qprecio_compra" type="text" class="cajaPequena"
                                                   id="precio_compra" size="10" maxlength="10"
                                                   value="<?php echo mysqli_result($rs_query, 0, "precio_compra") ?>">
                                <? echo $moneda; ?></td>
                        </tr>
                        <tr>
                            <td><span id="tpalmacen">Precio de almac&eacute;n</span></td>
                            <td colspan="2"><input NAME="qprecio_almacen" type="text" class="cajaPequena"
                                                   id="precio_almacen" size="10" maxlength="10"
                                                   value="<?php echo mysqli_result($rs_query, 0, "precio_almacen") ?>">
                                <? echo $moneda; ?></td>
                        </tr>
                        <tr>
                            <td><span id="tptienda">Precio de tienda</span></td>
                            <td colspan="2"><input NAME="qprecio_tienda" type="text" class="cajaPequena"
                                                   id="precio_tienda" size="10" maxlength="10"
                                                   value="<?php echo mysqli_result($rs_query, 0, "precio_tienda") ?>">
                                <? echo $moneda; ?></td>
                        </tr>
                        <!--<tr>
						  <td>Pvp</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input NAME="qprecio_iva" type="text" class="cajaPequena" id="precio_iva"
                                                   size="10" maxlength="10"
                                                   value="<?php echo mysqli_result($rs_query, 0, "precio_iva") ?>">
                                <? echo $moneda; ?></td>
                        </tr>
                        <tr>
                            <td><span id="timgfrmjpg">Imagen</span></td>
                            <td width="55%"><input type="file" name="foto" id="foto" class="cajaMedia"
                                                   accept="image/jpg"/></td>
                            <td width="30%" align="center" valign="top"><img
                                        src="<?php echo traerUrlImagenProducto(mysqli_result($rs_query, 0, "imagen")); ?>"
            ...
            <div id="botonBusqueda">
                <button type="button" id="btnaceptar" onClick="validar(formulario,true)"
                        onMouseOver="style.cursor=cursor"><img src="../img/ok.svg" alt="Aceptar"/> <span id="taceptar">Aceptar</span></td>
                </button>
                <button type="button" id="btnlimpiar" onClick="limpiar()" onMouseOver="style.cursor=cursor"><img
                            src="../img/limpiar.svg" alt="limpiar"/> <span id="tlimpiar">Limpiar</span></button>
                <button type="button" id="btncancelar" onClick="cancelar()" onMouseOver="style.cursor=cursor"><img
                            src="../img/borrar.svg" alt="nuevo"/> <span id="tcancelar">Cancelar</span></button>
