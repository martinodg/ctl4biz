<?php
$language="spanish";
$title_company="Datos de Compañia";
$id_resource='8';
$id_sresource='31';
        ...
        <script language="javascript">
         ...
         //---------------------------------------------------------------------------------------------------           
          ...
          function modificar(codrole) {
                                        location.href="modificarCompany.php" + "#" +codrole;
                                  }
          //---------------------------------------------------------------------------------------------------             
          ...
          $( document ).ready(function(){
                ...
                // $('#btnimprimir').click(function(){document.getElementById("form_busqueda").reset();});
            });
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header"><span id="tcompanydata">Datos de Compañia</span> </div>
				<div id="frmBusqueda">
				<form id="form_busqueda" name="form_busqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr style="display: none">
							<td width="20%"><span  id="company">compañia</span></td>

                            <td id="entrada1" with="20%">

                                  <select id='param1' name='param1' class='comboMedio'>
                                    <option value='' selected  data-opttrad="allcompany">Todos las compañias</option>
...
<tr>
							...
							<td width="20%">
                                <select id="crit2" name="2" class="comboMedio" >
                                    ...
                                    <option value="nombrecompany">Nombre de compañia</option>
                                    <option value="intUserMail">codigo de compañia</option>
                                    <option value="id_intUser">moneda</option>
...
<tr>
							<td width="20%"><span  id="tpais">Pais</span></td>
							<td width="20%">
                                <select id="crit3" name="3" class="comboMedio" >
                                    <option value="0">Elegir idoma</option>
                            ...
                            <td id="entrada3" with="20%" style="display: none">
		 	  ...
		 	  <div id="botonBusqueda">
					<button type="button" id="btnbuscarCompany" onMouseOver="style.cursor=cursor"> <img src="../../img/ver.svg" alt="buscar" /> <span  id="tbuscar">buscar</span> </button>
			  ...
			  <div id="lineaResultado" style="display: none">
                  <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
                    <tr>
                        ...
                        <td width="50%" class="paginar" align="right"><span  id="tmostra">Mostrados</span>
                        <select name="paginas" id="paginas" onChange="paginar()"></select>
                        </td>
                    </tr>
                  </table>
