					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
					 ...
					 <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
						<tr class="cabeceraTabla">
                            ...
                            <td width="25%"><span  id="trefren">REFERENCIA</span></td>
			  ...
			  <? $baseimpuestos=$baseimponible*($iva/100);
				...
				$preciototal=number_format($preciototal,2); ?>
					...
					<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
						...
						<tr>
							<td width="15%"><span  id="tiva">IVA</td>
				...
				<div id="botonBusqueda">
					<div align="center">
					 ...
					 <button type="button" id="btnimprimir"  onClick="imprimir(<? echo $codalbaran?>)" onMouseOver="style.cursor=cursor"> <img src="../img/printer.svg" alt="Imprimir" /> <span  id="timprimir">Imprimir</span> </button>
				        </div>
					</div>
			  </div>
		  </div>
