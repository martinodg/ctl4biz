		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					...
					<button type="button" id="btnlimpiar"  onClick="limpiar()" onMouseOver="style.cursor=cursor"> <img src="../img/limpiar.svg" alt="limpiar" /> <span id="tlimp">Limpiar</span> </button>
