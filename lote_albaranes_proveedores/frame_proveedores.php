...
<? if ($nrs>0) { ?>
        ...
        <div align="left"><?php echo utf8_encode($nombre);?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codproveedor?>,'<?php echo $nombre?>','<?php echo $nif?>')"><img src="../img/convertir.svg" border="0" title="Seleccionar"></a></div></td>					
				</tr>
			<?php }
		?>
  </table>
