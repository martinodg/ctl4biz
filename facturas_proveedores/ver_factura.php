			  ...
			  <? $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					...
					<button type="button" id="btnaceptar" onClick="aceptar()" onMouseOver="style.cursor=cursor"> <img src="../img/ok.svg" alt="aceptar" /> <span>Aceptar</span> </button>
					 <button type="button" id="btnimprimir"  actura?>','<? echo $codproveedor?>')" onMouseOver="style.cursor=cursor"> <img src="../img/printer.svg" alt="Imprimir" /> <span>Imprimir</span> </button>
				        </div>
					</div>
			  </div>
		  </div>
