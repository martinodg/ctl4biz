...
<html>
	...
	<div align="center">
        ...
        <br>
        <button type="button" class="fullwidth" id="tcompanydata" onClick="window.location.href = '../racf/companyData/modificar_company.php';" onMouseOver="style.cursor=cursor"><span id="tcompanydata">Datos de Compañia</span></button>
    </div>
            </div>
		</div>		  			
	</body>
