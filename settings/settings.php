...
<html>
	...
	<div align="center">
        ...
        <br>
        <button type="button" class="fullwidth" id="datacompany" onClick="window.location.href = '../racf/companyData/index.php';" onMouseOver="style.cursor=cursor"><span  id="tdatacompany">Datos de Compania</span> </button>
    </div>
            </div>
		</div>		  			
	</body>
