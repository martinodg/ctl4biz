...
include ("../conectar7.php"); 
	...
	$consulta="SELECT internalUsersTable.id_intUser, internalUsersTable.intUserName, internalUsersTable.intUserMail, estado.estado FROM internalUsersTable, estado WHERE ".$donde."internalUsersTable.borrado=0 ORDER BY internalUsersTable.intUserName LIMIT ".$paginainicio.",10;";
    //echo $consulta;
