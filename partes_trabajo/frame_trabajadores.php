...
function pon_prefijo(pref,nombre,nif) {
	parent.opener.document.formulario.codtrabajador.value=pref;
...
<? if ($nrs>0) { ?>
		...
		<?php
			for ($i = 0; $i < mysql_num_rows($rs_tabla); $i++) {
				$codtrabajador=mysql_result($rs_tabla,$i,"codtrabajador");
        ...
        <div align="left"><?php echo utf8_encode($nombre);?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codtrabajador?>,'<?php echo $nombre?>','<?php echo $nif?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>
				</tr>
			<?php }
		?>
  </table>
