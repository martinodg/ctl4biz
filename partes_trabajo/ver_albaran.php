			  ...
			  <? $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					<div align="center">
					 ...
					 <button type="button" id="btnimprimir"  onClick="imprimir(<? echo $codalbaran?>)" onMouseOver="style.cursor=cursor"> <img src="../img/printer.svg" alt="Imprimir" /> <span  id="timpr">Imprimir</span> </button>
				        </div>
					</div>
			  </div>
		  </div>
