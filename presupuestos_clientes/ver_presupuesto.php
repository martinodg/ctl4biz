	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
                    <div id="tituloForm" class="header"><span  id="tvpres">VER PRESUPUESTO</span></div>
				<div id="frmBusqueda">
				...
				$preciototal=number_format($preciototal,2); ?>
					...
					<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
						<tr>
							...
							<td width="15%"><?php echo number_format($baseimponible,2);?> <?echo $moneda;?></td>
						</tr>
						<tr>
							<td width="15%"><span  id="tiva">IVA</span></td>
							<td width="15%"><?php echo number_format($baseimpuestos,2);?> <?echo $moneda;?></td>
						</tr>
						<tr>
							<td width="15%"><span  id="ttotal">Total</span></td>
							<td width="15%"><?php echo $preciototal?> <?echo $moneda;?></td>
						</tr>
					</table>
			  </div>
