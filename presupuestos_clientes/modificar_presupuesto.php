...
while ($contador < mysqli_num_rows($rs_lineas)) {
	...
	$descripcion=mysqli_result($rs_lineas,$contador,"descripcion");
	$numlineapt=mysqli_result($rs_lineas,$contador,"numlinea");
	...
	$sel_tmp="INSERT INTO presulineatmp (codpresupuesto,numlinea,descripcion,codfamilia,codigo,cantidad,precio,importe,dcto) VALUES ('$codpresupuestotmp','$numlineapt','$descripcion','$codfamilia','$codigo','$cantidad','$precio','$importe','$dcto')";
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
                    <div id="tituloForm" class="header"><span  id="tinspres">INSERTAR presupuesto</span></div>
				<div id="frmBusqueda">
			  ...
			  <div id="frmBusqueda">
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  ...
				  <tr>
					...
					<td width="11%"><input NAME="precio" type="text" class="cajaPequena2" id="precio" size="10" maxlength="10" onChange="actualizar_impor<?echo $m <?echo $moneda;?></td>
			...
			<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
			  <tr>
				...
				<td width="73%" align="right"><div align="center">
			      <input class="cajaTotales" name="baseimponible" type="text" id="baseimponible" size="12" align="right" value="<? echo number_format($baseimponible,2)?>" re <?echo $moneda;?></div></td>
			  </tr>
			  <tr>
