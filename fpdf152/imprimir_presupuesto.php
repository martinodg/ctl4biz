...
$resultado = mysqli_query($conexion,$consulta, $conexion);
$lafila=mysqli_fetch_array($resultado);
	...
	$pdf->Cell(20,4,"Cod. Presup.",1,0,'C',1);
	$pdf->Ln(4);
	...
	$pdf->Cell(30,4,$fecha,1,0,'C',1);
	$pdf->Cell(20,4,$codpresupuesto,1,0,'C',1);
	...
	$consulta2 = "Select * from presulinea where codpresupuesto='$codpresupuesto' order by numlinea";
    $resultado2 = mysqli_query($conexion,$consulta2, $conexion);
