...
$rs_lineas=mysqli_query($conexion,$sel_lineas);
			  ...
			  <? $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					<div align="center">
					<button type="button" id="btnaceptar" onClick="aceptar(<? echo $codfactura?>)" onMouseOver="style.cursor=cursor"> <img src="../img/ok.svg" alt="aceptar" /> <span>Aceptar</span> </button>
